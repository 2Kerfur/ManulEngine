...
VkShaderModule createShaderModule(const std::vector<char>& code, VkDevice vk_device) {
...
void VulkanPipline::createCommandPool(VkPhysicalDevice physicalDevice, VkDevice device, VkSurfaceKHR surface) {
...
void VulkanPipline::createCommandBuffer(VkDevice device) {
...
void VulkanPipline::createSyncObjects(VkDevice device) {
